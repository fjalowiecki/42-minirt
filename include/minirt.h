...
double			calc_light_angle_sphere(t_pixel_data *pixel_data,
					t_view *view, t_light *light, t_sphere *sph);
...
/*obj_args.c*/
/* shaded_pixel.c */
bool			shaded_pixel(t_point3 intersection,
					t_point3 light, t_data *data);
...
t_vec3			cylinder_normal(t_point3 intersect_to_center,
					t_cylinder *cyl);
